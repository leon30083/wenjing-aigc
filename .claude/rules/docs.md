...
> **📌 开发流程**: 本规范是 **Plan → Code → Update Docs** 流程的最后一步
> **详细流程**: 请参考 `.claude/rules/quick-reference.md` 中的"⭐ 开发流程规范"
...
## 新增错误模式时的打标规范 ⭐ 2026-01-06 新增

每次新增错误模式时，必须按照以下规范添加类型标签。

### 1. 类型标签定义

| 标签 | 说明 | 示例 |
|------|------|------|
| `API` | API 调用、端点、参数相关 | 双平台任务ID不兼容 |
...
### 错误48: 优化节点错误使用双显示功能 `Character` `React Flow`
```
