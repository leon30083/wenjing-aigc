...
| 文档 | 更新内容 | 优先级 |
|------|----------|--------|
| `.claude/skills/winjin-dev/SKILL.md` | 新增错误模式、API 规范 | ⭐ 必须 |
| `.claude/rules/base.md` | 技术规范、API 端点、平台差异 | ⭐ 必须 |
| `.claude/rules/code.md` | 代码示例、错误模式、最佳实践 | ⭐ 必须 |
...
1. **SKILL.md** - 添加新的错误模式或规范
2. **base.md** - 更新技术规范（如果涉及 API 变更）
3. **code.md** - 更新错误模式和代码示例
4. **Sora2_Character_Best_Practices.md** - 更新最佳实践（推荐）
5. **开发交接书.md** - 更新版本号和功能列表
...
- Updated code.md with error examples
...
- [ ] SKILL.md 已添加新的错误模式或规范
- [ ] base.md 已更新技术规范（如果需要）
- [ ] code.md 已更新错误模式和代码示例
- [ ] 开发交接书.md 版本号已更新
