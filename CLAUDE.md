...
| 哲学 | 核心思想 | 文档 |
|------|---------|------|
| **胶水编程** | AI 连接代码，人审连接 | [00-philosophy/glue-programming.md](.claude/00-philosophy/glue-programming.md) |
| **强约束** | 约束不是限制，而是保护 | [00-philosophy/strong-constraints.md](.claude/00-philosophy/strong-constraints.md) |
| **血的教训** | 10 分开发，7 分找资料 | [00-philosophy/blood-lessons.md](.claude/00-philosophy/blood-lessons.md) |
...
│   ├── strong-constraints.md   # 28条约束 + WinJin扩展
│   └── blood-lessons.md        # 血的教训
│
├── 01-fundamentals/            # 基础知识层 - 技术基础
│   ├── tech-stack.md           # 技术栈和框架版本
│   ├── language-layers.md      # 12层语言要素 + 代码规范
│   └── api-platforms.md        # Sora2 双平台规范
│
├── 02-methodology/             # 方法论层 - 开发流程
│   ├── development-flow.md     # Plan → Code → Update
│   ├── testing-automation.md   # MCP 测试自动化
│   ├── canvas-driven-dev.md    # React Flow 白板驱动
│   └── documentation-standards.md # 文档规范
│
├── 03-node-development/        # 节点开发层 - React Flow
│   ├── node-architecture.md    # 节点架构模式
│   ├── handle-connections.md   # Handle 连接规范
│   ├── node-templates.md       # 节点模板
│   └── language-layer-checklist.md # 12层检查清单
│
├── 04-error-patterns/          # 错误模式层 - 错误管理
│   ├── errors-by-type.md       # 55个错误（按类型）
│   ├── glue-constraints.md     # 约束→错误映射
│   ├── prevention-checklist.md # 预提交检查清单
│   └── error-evolution.md      # 错误演化历史
│
├── 05-automation/              # 自动化层 - 系统增强
│   ├── mcp-integration.md      # MCP 集成
│   ├── auto-testing.md         # 自动化测试
...
│
└── templates/                  # 模板层 - 代码模板
    ├── node-template.jsx       # 节点模板
    ├── api-route-template.js   # API 路由模板
    └── error-report-template.md # 错误报告模板
```
...
1. **阅读哲学层** (15分钟)
   - [胶水编程原理](.claude/00-philosophy/glue-programming.md) - 理解开发范式
   - [血的教训](.claude/00-philosophy/blood-lessons.md) - 学会调研优先

2. **了解技术栈** (10分钟)
   - [技术栈约束](.claude/01-fundamentals/tech-stack.md) - 运行时环境和框架版本
   - [API 规范](.claude/01-fundamentals/api-platforms.md) - Sora2 双平台差异

3. **开始开发**
   - [开发流程](.claude/02-methodology/development-flow.md) - Plan → Code → Update
   - [节点架构](.claude/03-node-development/node-architecture.md) - React Flow 节点开发

### 常见问题

| 问题 | 查看文档 |
|------|---------|
| 如何创建新节点？ | [节点架构](.claude/03-node-development/node-architecture.md) |
| 如何避免常见错误？ | [错误模式库](.claude/04-error-patterns/errors-by-type.md) |
| 双平台差异是什么？ | [API 规范](.claude/01-fundamentals/api-platforms.md) |
| 如何测试代码？ | [测试自动化](.claude/02-methodology/testing-automation.md) |
| 代码规范是什么？ | [语言层要素](.claude/01-fundamentals/language-layers.md) |
...
- 所有错误模式记录在 `.claude/04-error-patterns/errors-by-type.md`
...
A: 参考 `.claude/03-node-development/handle-connections.md` 中的"连接验证规范"章节
...
A: 参考 `.claude/04-error-patterns/errors-by-type.md` 中的错误模式
...
**内部文档**:
- [哲学层](.claude/00-philosophy/) - 核心理念（胶水编程、约束、血的教训）
- [基础知识层](.claude/01-fundamentals/) - 技术栈、语言层要素、API 规范
- [方法论层](.claude/02-methodology/) - 开发流程、测试自动化
- [节点开发层](.claude/03-node-development/) - 节点架构、Handle 连接
- [错误模式层](.claude/04-error-patterns/) - 错误库、约束映射、预防清单
