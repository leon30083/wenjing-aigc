...
一套经过实战验证的高效开发方式，基于 Claude Code + 规则驱动 + 文档同步 + Plan-First 流程。

## ✨ 核心特性

- 🎯 **Plan-First 开发流程** ⭐ 新增 - 先规划后实现，确保质量
...
**何时使用 Plan 模式**:
- ✅ **必须使用**: 新功能、架构变更、复杂重构、多文件修改
- ❌ **可以跳过**: 单行修改、简单Bug、文档更新
